      ...
      <View className="flex-1 justify-end bg-black/30">
        ...
        <View className="bg-white rounded-t-3xl max-h-[90%] min-h-[50%]">
                ...
                <View className="mb-6">
                  ...
                  <View className="flex-row justify-between">
                    <View className="items-center flex-1">
                      ...
                      <AppText className="text-xs text-gray-500 mt-1">Calories</AppText>
                    </View>
                    <View className="items-center flex-1">
                      <AppText className="text-xl font-bold text-gray-900">
                        {meal.nutrition.protein}g
                      </AppText>
                      <AppText className="text-xs text-gray-500 mt-1">Protein</AppText>
                    </View>
                    <View className="items-center flex-1">
                      <AppText className="text-xl font-bold text-gray-900">
                        {meal.nutrition.carbs}g
                      </AppText>
                      <AppText className="text-xs text-gray-500 mt-1">Carbs</AppText>
                    </View>
                    <View className="items-center flex-1">
                      <AppText className="text-xl font-bold text-gray-900">
                        {meal.nutrition.fat}g
                      </AppText>
                      <AppText className="text-xs text-gray-500 mt-1">Fat</AppText>
                    </View>
                  </View>
                </View>
            ...
            <View className="flex-row items-center p-6 border-t border-gray-200 bg-white">
              ...
              >
                <AppText className="text-white text-base font-semibold">Add to Cart</AppText>
              </TouchableOpacity>
            </View>
          </View>
      </View>
