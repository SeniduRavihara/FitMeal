...
export const FITNESS_GOALS = [
  { id: 'muscle_gain', name: 'Muscle Gain', icon: '💪', description: 'Build lean muscle mass' },
  { id: 'fat_loss', name: 'Fat Loss', icon: '🔥', description: 'Burn fat and get lean' },
  { id: 'maintenance', name: 'Maintenance', icon: '⚖️', description: 'Maintain current weight' },
];
