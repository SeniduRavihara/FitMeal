            ...
            <View className="flex-1">
              ...
              <AppText className="text-base text-gray-500">
                {session
                  ...
                  : "Explore our healthy meals"}
              </AppText>
            </View>
            <TouchableOpacity
              className="w-12 h-12 bg-orange-500 rounded-full items-center justify-center shadow-sm relative"
          ...
          <View className="flex-row justify-between items-center mb-6">
            <AppText className="text-xl font-bold text-gray-900">
              {selectedCategory === "all"
                ? "All Meals"
                : MEAL_CATEGORIES.find((c) => c.id === selectedCategory)?.name}
            </AppText>
