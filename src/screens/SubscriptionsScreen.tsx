    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FAFAFA' }}>
      ...
      <View className="px-6 space-y-4">
        {SUBSCRIPTION_PLANS.map((plan) => (
          <View key={plan.id} className={`bg-white rounded-2xl p-6 shadow-sm ${plan.isPopular ? 'border-2 border-orange-500' : 'border border-gray-200'}`}>
            {/* Plan Header */}
            ...
            >
              <AppText className={`text-center font-semibold ${plan.isPopular ? 'text-white' : 'text-orange-500'}`}>
